...
class CVersionedProjectCtrl : public ITcOCFCtrlImpl<CVersionedProjectCtrl, CVersionedProjectClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("VersionedProject: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CVersionedProjectCtrl>;
